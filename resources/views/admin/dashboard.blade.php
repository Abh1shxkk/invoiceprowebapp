...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Revenue Overview (Last 6 Months)</h3>
            </div>
            <div class="p-6">
                <div class="space-y-4">
                    @foreach($monthlyRevenueData as $data)
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <span class="text-sm font-semibold text-gray-900">${{ number_format($data['revenue'], 2) }}</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $data['revenue'] > 0 ? min(($data['revenue'] / max(array_column($monthlyRevenueData, 'revenue'))) * 100, 100) : 0 }}%"></div>
                            </div>
                        </div>
                    @endforeach
                </div>
