...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Record a business expense</p>
        </div>

        <form action="{{ route('user.expenses.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                    Don't see your category? <a href="{{ route('user.categories.create') }}" class="text-blue-600 hover:text-blue-700">Create a new one</a>
                </p>
            </div>
